  ...
  const form = (
    <>
      ...
      <div className={emailOnly ? "mt-2" : "text-center"}>
        ...
        <p className={`iz-tiny iz-muted ${emailOnly ? "mt-0 text-[15px] font-semibold text-[var(--iz-txt)]" : "mt-1.5"}`}>
          {portalLabel} sign in
        </p>
        {emailOnly && (
          <p className="iz-tiny iz-muted2 mt-1">Use your work email to access the {portalLabel.toLowerCase()} portal.</p>
        )}
      </div>

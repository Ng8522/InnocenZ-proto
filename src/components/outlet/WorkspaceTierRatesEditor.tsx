...
export function WorkspaceTierRatesEditor({
  ...
  const workspaceHeader = (
    <>
      ...
      {!hideTargetSales && <div className={tierTableHeadCell(undefined, true)}>Target sales</div>}

      <div className={tierTableHeadCell("text-center leading-tight", true)}>HH Drinks</div>

      <div className={tierTableHeadCell("text-center leading-tight", true)}>NH Drinks</div>
  ...
  const workspaceTierRow = (tier: OutletPrTier) => {
    ...
    return (
      <>
        ...
        <div
          className={
            readOnly ? tierTableCell("bg-black/15 text-[var(--iz-muted)]") : tierTableEditableCell()
          }

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0c0917" },
      { title: "InnocenZ — Connect. Engage. Entertain." },
      { name: "description", content: "InnocenZ is the nightlife operations platform connecting outlets, agencies, PR talent and guests in one tap." },
